...
Route::group(['prefix' => 'sales'], function () {
    ...
    Route::get('invoices/{invoice}/picked', 'Sales\Invoices@markPicked')->name('invoices.picked');
...
Route::group(['prefix' => 'purchases'], function () {
    ...
    Route::get('bills/{bill}/picked', 'Purchases\Bills@markPicked')->name('bills.picked');
...
Route::group(['prefix' => 'settings'], function () {
    ...
    Route::group(['as' => 'settings.'], function () {
        ...
        Route::get('courier', 'Settings\Courier@edit')->name('courier.edit');
        Route::patch('courier', 'Settings\Courier@update')->name('courier.update');
    });
});
