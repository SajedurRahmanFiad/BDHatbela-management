                        ...
                        @switch($type)
                            @case('button')
                                ...
                                <div class="w-full flex items-center text-purple px-2 h-9 leading-9 whitespace-nowrap">
                                    <button type="button" class="w-full h-full flex items-center rounded-md px-2 text-sm hover:bg-lilac-100" {!! $action['attributes'] ?? null !!}>
                                        {{ $action['title'] }}
                                    </button>
                                </div>
                                @break
                            ...
                            @default
                                ...
                                <div class="w-full flex items-center text-purple px-2 h-9 leading-9 whitespace-nowrap">
                                    <a href="{{ $action['url'] }}" {!! $action['attributes'] ?? null !!} x-data="{ clicked: false }" x-on:click="clicked = true;" x-bind:class="{ 'pointer-events-none': clicked }" class="w-full h-full flex items-center rounded-md px-2 text-sm hover:bg-lilac-100">
                                        {{ $action['title'] }}
                                    </a>
                                </div>
                        @endswitch
