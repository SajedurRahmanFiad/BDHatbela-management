<x-form.accordion type="company" class="hidden" :open="(! $hideLogo && empty(setting('company.logo')))">
    <x-slot name="head">
    ...
    <x-slot name="body">
        {{-- Always include current company id so document creation has a company_id when submitted --}}
