...
return [
    ...
    'roles' => [
        'admin' => [
            'name'          => 'Admin',
            'description'   => 'They get full access to your Dashboard including customers, invoices, reports, settings, and apps.',
        ],
        'manager' => [
            'name'          => 'Manager',
            'description'   => 'They get full access to your Dashboard, but can\'t manage users and apps.',
        ],
        'customer' => [
            'name'          => 'Customer',
