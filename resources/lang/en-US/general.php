...
return [
    ...
    'items'                 => 'Item|Items',
    'invoices'              => trans('dynamic.invoice') . '|' . trans('dynamic.invoices'),
    ...
    'edit'                  => 'Edit',
    'delete'                => 'Delete',
    'send'                  => trans('dynamic.send'),
    'send_email'            => trans('dynamic.send_email'),
    'send_to'               => 'Send To',
    'receive'               => 'Receive',
    'share'                 => 'Share',
    ...
    'color'                 => 'Color',
    'save'                  => 'Save',
    'save_and_send'         => 'Save & ' . trans('dynamic.send'),
    'confirm'               => 'Confirm',
    'cancel'                => 'Cancel',
    'loading'               => 'Loading...',
    'from'                  => 'From',
    ...
    'create_first_invoice'  => 'Create your first ' . trans('dynamic.invoice'),
    'is'                    => 'is',
    'isnot'                 => 'is not',
    ...
    // Admin activity verbs
    'created_expense'       => 'created an expense',
    'created_transaction'   => 'created a transaction',
    'created_transfer'      => 'created a transfer',
    'created_bill'          => 'created a bill',
    'invite'                => 'Invite',
    'common'                => 'Common',
    'api'                   => 'API',
    ...
    'resend'                => 'Resend',
    'last_sent'             => 'Last ' . trans('dynamic.sent_on', [ 'date' => ':date' ]),
    ...
    'empty' => [
        ...
        'invoices' => trans('dynamic.invoices') . ' can be one time or recurring. You can ' . trans('dynamic.send') . ' them to customers and start accepting online payments.',
