...
class AddLandingPages
{
    ...
    public function handle(Event $event)
    {
        ...
        $isEmployeeRole = $role && $role->name == 'employee';
        ...
        foreach ($routes as $key => $route) {
            // Always expose the main dashboard as a landing page for employees,
            // even if the 'employee' role itself does not have the dashboard permission assigned.
            if ($isEmployeeRole && $key === 'dashboard') {
