...
class Payables extends Widget
{
    ...
    public function show()
    {
        ...
        // Keep detailed overdue periods for the aged report dropdown,
        // but the main widget headline will now show a single "Payables" total
        ...
        // "Payables" should include both open and overdue amounts
        $grand = $open + $overdue;

        $totals = [
            'grand'      => money($grand),
            'payables'   => money($grand),
        ];
