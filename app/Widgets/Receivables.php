...
class Receivables extends Widget
{
    ...
    public function show()
    {
        ...
        // Keep the detailed overdue periods for use in the aged report dropdown,
        // but the main widget headline will now show a single "Receivables" total
        // that already includes overdue.
        $periods = [
            'overdue_1_30' => 0,
            'overdue_30_60' => 0,
            'overdue_60_90' => 0,
        ...
        // "Receivables" should include both open and overdue amounts
        $grand = $open + $overdue;

        $totals = [
            'grand'        => money($grand),
            'receivables'  => money($grand),
        ];
