...
abstract class Show extends Component
{
    ...
    /** @var bool */
    public $hideStealthfastCourier;

    /** @var string */
    public $stealthfastCourierRoute;

    /** @var string */
    public $textStealthfastCourier;
    ...
    /** @var bool */
    public $hideMarkPicked;

    /** @var string */
    public $markPickedRoute;
    ...
    public function __construct(
        ...
        bool $hideMarkPicked = false, string $markPickedRoute = '',
        ...
        $this->hideMarkPicked = $hideMarkPicked;
        $this->markPickedRoute = $this->getMarkPickedRoute($type, $markPickedRoute);
    ...
    protected function getMarkPickedRoute($type, $markPickedRoute)
    {
        if (! empty($markPickedRoute)) {
            return $markPickedRoute;
        }
