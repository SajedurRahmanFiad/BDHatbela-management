...
class Profile extends FormRequest
{
    ...
    public function rules()
    {
        ...
        // Use RFC-only email validation (no DNS check) to allow internal/local emails when updating profile
        $email = 'required|email:rfc|unique:users,email,' . $id . ',id,deleted_at,NULL';
