...
class Bills extends Controller
{
    ...
    /**
     * Mark the bill as picked.
     *
     * @param  Document $bill
     *
     * @return Response
     */
    public function markPicked(Document $bill)
    {
        event(new \App\Events\Document\DocumentMarkedPicked($bill));

        $message = trans('documents.messages.marked_as', ['type' => trans_choice('general.bills', 1), 'status' => trans('documents.statuses.picked')]);
