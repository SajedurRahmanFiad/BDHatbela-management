...
class Event extends Provider
{
    ...
    protected $listen = [
        ...
        'App\Events\Document\DocumentCreated' => [
            ...
            'App\Listeners\Document\NotifyAdminsOnDocumentCreated',
        ],
        ...
        'App\Events\Document\DocumentMarkedPicked' => [
            'App\Listeners\Document\MarkDocumentPicked',
        ],
        ...
        'App\Events\Banking\TransactionCreated' => [
            ...
            'App\Listeners\Banking\NotifyAdminsOnTransactionCreated',
        ],
